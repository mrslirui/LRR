...
- (id)initWithText:(NSString *)text
{
    if (self = [super init]) {
        ...
        UILabel *textLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, rect.size.width + 10, rect.size.height + 5)];
        ...
        _contentView.contentEdgeInsets = UIEdgeInsetsMake(3, 3, 3, 3);
        _contentView.layer.cornerRadius = 11.5f;
...
{
    [XLToast showTopWithText:text duration:ToastDispalyDuration];
}
+ (void)showCenterWithText:(NSString *)text duration:(CGFloat)duration
{
    XLToast *toast = [[XLToast alloc] initWithText:text];
...
{
    [XLToast showTopWithText:text topOffset:100.0f duration:ToastDispalyDuration];
}
+ (void)showTopWithText:(NSString *)text duration:(CGFloat)duration
{
    [XLToast showTopWithText:text topOffset:100.0f duration:duration];
}
+ (void)showTopWithText:(NSString *)text topOffset:(CGFloat)topOffset
{
    [XLToast showTopWithText:text topOffset:topOffset duration:ToastDispalyDuration];
}
...
{
    [XLToast showBottomWithText:text bottomOffset:100.0f duration:ToastDispalyDuration];
}
+ (void)showBottomWithText:(NSString *)text duration:(CGFloat)duration
{
    [XLToast showBottomWithText:text bottomOffset:100.0f duration:duration];
}
+ (void)showBottomWithText:(NSString *)text bottomOffset:(CGFloat)bottomOffset
{
    [XLToast showBottomWithText:text bottomOffset:bottomOffset duration:ToastDispalyDuration];
}
+ (void)showBottomWithText:(NSString *)text bottomOffset:(CGFloat)bottomOffset duration:(CGFloat)duration
{
    XLToast *toast = [[XLToast alloc] initWithText:text];
    [toast setDuration:duration];
    [toast showFromTopOffset:bottomOffset];
}
@end
